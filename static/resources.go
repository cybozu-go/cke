...
var Resources = []cke.ResourceDefinition{
	...
	},
	{
		...
		Name:       "cluster-dns",
		Revision:   1,
		Image:      "quay.io/cybozu/coredns:1.6.6.2",
		Definition: []byte("{\"kind\":\"Deployment\",\"apiVersion\":\"apps/v1\",\"metadata\":{\"name\":\"cluster-dns\",\"namespace\":\"kube-system\",\"creationTimestamp\":null,\"annotations\":{\"cke.cybozu.com/image\":\"quay.io/cybozu/coredns:1.6.6.2\",\"cke.cybozu.com/revision\":\"1\"}},\"spec\":{\"replicas\":2,\"selector\":{\"matchLabels\":{\"cke.cybozu.com/appname\":\"cluster-dns\"}},\"template\":{\"metadata\":{\"creationTimestamp\":null,\"labels\":{\"cke.cybozu.com/appname\":\"cluster-dns\",\"k8s-app\":\"coredns\"},\"annotations\":{\"prometheus.io/port\":\"9153\"}},\"spec\":{\"volumes\":[{\"name\":\"config-volume\",\"configMap\":{\"name\":\"cluster-dns\",\"items\":[{\"key\":\"Corefile\",\"path\":\"Corefile\"}]}}],\"containers\":[{\"name\":\"coredns\",\"image\":\"quay.io/cybozu/coredns:1.6.6.2\",\"args\":[\"-conf\",\"/etc/coredns/Corefile\"],\"ports\":[{\"name\":\"dns\",\"containerPort\":1053,\"protocol\":\"UDP\"},{\"name\":\"dns-tcp\",\"containerPort\":1053,\"protocol\":\"TCP\"},{\"name\":\"metrics\",\"containerPort\":9153}],\"resources\":{\"limits\":{\"memory\":\"170Mi\"},\"requests\":{\"cpu\":\"100m\",\"memory\":\"70Mi\"}},\"volumeMounts\":[{\"name\":\"config-volume\",\"readOnly\":true,\"mountPath\":\"/etc/coredns\"}],\"livenessProbe\":{\"httpGet\":{\"path\":\"/health\",\"port\":8080,\"scheme\":\"HTTP\"},\"initialDelaySeconds\":60,\"timeoutSeconds\":5,\"successThreshold\":1,\"failureThreshold\":5},\"readinessProbe\":{\"httpGet\":{\"path\":\"/health\",\"port\":8080,\"scheme\":\"HTTP\"},\"timeoutSeconds\":5},\"lifecycle\":{\"preStop\":{\"exec\":{\"command\":[\"sh\",\"-c\",\"sleep 5\"]}}},\"imagePullPolicy\":\"IfNotPresent\",\"securityContext\":{\"capabilities\":{\"drop\":[\"all\"]},\"readOnlyRootFilesystem\":true,\"allowPrivilegeEscalation\":false}}],\"dnsPolicy\":\"Default\",\"serviceAccountName\":\"cke-cluster-dns\",\"tolerations\":[{\"key\":\"node-role.kubernetes.io/master\",\"effect\":\"NoSchedule\"},{\"key\":\"CriticalAddonsOnly\",\"operator\":\"Exists\"}],\"priorityClassName\":\"system-cluster-critical\"}},\"strategy\":{\"type\":\"RollingUpdate\",\"rollingUpdate\":{\"maxUnavailable\":1}}},\"status\":{}}\n"),
	},
	{
		...
		Name:       "node-dns",
		Revision:   1,
		Image:      "quay.io/cybozu/unbound:1.9.5.1",
		Definition: []byte("{\"kind\":\"DaemonSet\",\"apiVersion\":\"apps/v1\",\"metadata\":{\"name\":\"node-dns\",\"namespace\":\"kube-system\",\"creationTimestamp\":null,\"annotations\":{\"cke.cybozu.com/image\":\"quay.io/cybozu/unbound:1.9.5.1\",\"cke.cybozu.com/revision\":\"1\"}},\"spec\":{\"selector\":{\"matchLabels\":{\"cke.cybozu.com/appname\":\"node-dns\"}},\"template\":{\"metadata\":{\"creationTimestamp\":null,\"labels\":{\"cke.cybozu.com/appname\":\"node-dns\"}},\"spec\":{\"volumes\":[{\"name\":\"config-volume\",\"configMap\":{\"name\":\"node-dns\",\"items\":[{\"key\":\"unbound.conf\",\"path\":\"unbound.conf\"}]}}],\"containers\":[{\"name\":\"unbound\",\"image\":\"quay.io/cybozu/unbound:1.9.5.1\",\"args\":[\"-c\",\"/etc/unbound/unbound.conf\"],\"resources\":{},\"volumeMounts\":[{\"name\":\"config-volume\",\"mountPath\":\"/etc/unbound\"}],\"livenessProbe\":{\"tcpSocket\":{\"port\":53,\"host\":\"localhost\"},\"initialDelaySeconds\":1,\"periodSeconds\":1,\"failureThreshold\":6},\"readinessProbe\":{\"tcpSocket\":{\"port\":53,\"host\":\"localhost\"},\"periodSeconds\":1},\"lifecycle\":{\"preStop\":{\"exec\":{\"command\":[\"sh\",\"-c\",\"sleep 5\"]}}},\"securityContext\":{\"capabilities\":{\"add\":[\"NET_BIND_SERVICE\"],\"drop\":[\"all\"]},\"readOnlyRootFilesystem\":true,\"allowPrivilegeEscalation\":false}},{\"name\":\"reload\",\"image\":\"quay.io/cybozu/unbound:1.9.5.1\",\"command\":[\"/usr/local/bin/reload-unbound\"],\"resources\":{},\"volumeMounts\":[{\"name\":\"config-volume\",\"mountPath\":\"/etc/unbound\"}],\"securityContext\":{\"capabilities\":{\"drop\":[\"all\"]},\"readOnlyRootFilesystem\":true,\"allowPrivilegeEscalation\":false}}],\"terminationGracePeriodSeconds\":0,\"nodeSelector\":{\"kubernetes.io/os\":\"linux\"},\"serviceAccountName\":\"cke-node-dns\",\"hostNetwork\":true,\"tolerations\":[{\"operator\":\"Exists\",\"effect\":\"NoSchedule\"},{\"key\":\"CriticalAddonsOnly\",\"operator\":\"Exists\"},{\"operator\":\"Exists\",\"effect\":\"NoExecute\"}],\"priorityClassName\":\"system-node-critical\"}},\"updateStrategy\":{\"type\":\"RollingUpdate\",\"rollingUpdate\":{\"maxUnavailable\":1}}},\"status\":{\"currentNumberScheduled\":0,\"numberMisscheduled\":0,\"desiredNumberScheduled\":0,\"numberReady\":0}}\n"),
	},
	{
