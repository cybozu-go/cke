...
const (
	EtcdImage            = Image("quay.io/cybozu/etcd:3.5.4.1")
	KubernetesImage      = Image("quay.io/cybozu/kubernetes:1.22.11.1")
	...
	UnboundExporterImage = Image("quay.io/cybozu/unbound_exporter:0.4.1.2")
)
