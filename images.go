...
const (
	...
	HyperkubeImage = Image("quay.io/cybozu/hyperkube:1.16.5.1")
	ToolsImage     = Image("quay.io/cybozu/cke-tools:1.6.6")
	PauseImage     = Image("quay.io/cybozu/pause:3.1.0.3")
	CoreDNSImage   = Image("quay.io/cybozu/coredns:1.6.6.2")
