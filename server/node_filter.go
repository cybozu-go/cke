...
// APIServerHealthy filters nodes which have healthy API servers.
...
// APIServerUnhealthy filters nodes which have unhealthy API servers.
// This function also returns nodes on which the API server is not running.
